...
//	@RequestMapping(Constants.Paths.SLASH + Constants.Paths.READ_COOKIE)
//	public ModelAndView readCookie(@CookieValue(value = Constants.VALUE,
//			defaultValue = StringUtils.EMPTY) String myCookie, HttpServletRequest request) {
//
//		String myCookie2 = "";
//		Cookie[] cookies = request.getCookies();
//
